                ...
                <div class="col-lg-6">
                    <div class="left-content">
                        <div class="thumb">
                            ...
                            <img src="{{ URL::asset('public/frontend/images/left-banner-image.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{ URL::asset('public/frontend/images/baner-right-image-01.jpg')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{ URL::asset('public/frontend/images/baner-right-image-02.jpg')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{ URL::asset('public/frontend/images/baner-right-image-03.jpg')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{ URL::asset('public/frontend/images/baner-right-image-04.jpg')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="owl-kid-item owl-carousel">
                            @php
                                foreach($get_product as $val){
                                    $image = $val['product_images'][0]['product_image'];
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ url('public/assets/backend/images/productImages').'/'.$image}}" alt="" style="height: 427px;width: 100%;">
                                </div>
